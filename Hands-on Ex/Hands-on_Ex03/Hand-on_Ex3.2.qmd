...
In this hands-on exercise, I learned how to create animated data visualisation by using **gganimate** and **plotly r** packages. At the same time, I also (i) reshaped data by using **tidyr** package, and (ii) processed, wrangled and transformed data by using **dplyr** package.
...
country_colors <- setNames(
  scales::hue_pal()(nlevels(globalPop$Country)),
...
In this sub-section, I learned how to create an animated bubble plot by using `ggplotly()` method.
...
In this sub-section, I learned how to create an animated bubble plot by using `plot_ly()` method.
