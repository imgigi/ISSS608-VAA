...
In this hands-on exercise, I learned how to create interactive data visualisation by using functions provided by **ggiraph** and **plotlyr** packages.

## 3.2 Getting Started

I checked, installed and launched the following R packages:
