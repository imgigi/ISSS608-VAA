...
In this hands-on exercise, I gained hands-on experience on using R to plot static and interactive heatmap for visualising and analysing multivariate data.

## Installing and Launching R Packages

Install and load the following R packages: **seriation**, **heatmaply**, **dendextend**, **RColorBrewer**, and **tidyverse**.

```{r}
pacman::p_load(seriation, dendextend, heatmaply, RColorBrewer, tidyverse)
```

## Importing and Preparing The Data Set

In this hands-on exercise, the data of [World Happiness 2018 report](https://worldhappiness.report/ed/2018/) will be used. The data set is downloaded from [here](https://s3.amazonaws.com/happiness-report/2018/WHR2018Chapter2OnlineData.xls). The original data set is in Microsoft Excel format. It has been extracted and saved in csv file called **WHData-2018.csv**.
...
In this section, I learned how to plot static heatmaps by using **heatmap()** of *R Stats* package.

### heatmap() of R Stats

In this sub-section, I plotted a heatmap by using *heatmap()* of Base Stats. The code chunk is given below.
...
Here, red cells denote small values, and red small ones. This heatmap is not really informative. Indeed, the Happiness Score variable has relatively higher values, which makes that the other variables with small values all look the same. Thus, we need to normalize this matrix. This is done using the *scale* argument. It can be applied to rows or to columns following your needs.
...
Before getting started, I reviewed the [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html) to have an overall understanding of the features and functions of Heatmaply package. I also had the [user manual](https://cran.r-project.org/web/packages/heatmaply/heatmaply.pdf) of the package handy for reference purposes.

In this section, I gained hands-on experience on using **heatmaply** to design an interactive cluster heatmap. We will still use the wh_matrix as the input data.
