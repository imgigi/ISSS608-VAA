...
By the end of this hands-on exercise, I gained hands-on experience on:
...
In this section, I learned how to plot static parallel coordinates plot by using [`ggparcoord()`](https://ggobi.github.io/ggally/reference/ggparcoord.html) of **GGally** package. Before getting started, it is a good practice to read the function description in detail.
...
The basic parallel coordinates failed to reveal any meaning understanding of the World Happiness measures. In this section, I learned how to makeover the plot by using a collection of arguments provided by `ggparcoord()`.
...
[**parallelPlot**](https://cran.r-project.org/web/packages/parallelPlot/) is an R package specially designed to plot parallel coordinates plots using the 'htmlwidgets' package and [d3.js](https://d3js.org/). This section introduces how to use functions provided in the parallelPlot package to build interactive parallel coordinates plots.
...
Notice that some of the axis labels are too long. I learned how to overcome this problem in the next step.
